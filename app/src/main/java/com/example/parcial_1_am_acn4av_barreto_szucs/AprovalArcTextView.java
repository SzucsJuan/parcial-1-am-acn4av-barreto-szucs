...
public class AprovalArcTextView extends View {
    private Paint paint;
    private Path path;
    private String text = "HOOKN'T";

    public AprovalArcTextView(Context context, @Nullable AttributeSet attrs){
        super(context, attrs);
        init();
    }
    ...
    //Metodos para modificar parametros en clase originante(AprovalActivity)
